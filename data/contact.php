...
// User settings
$to = "info@party-pooper.com";
$subject = "Party Pooper Information Request";
...
if (empty($action)) {
	...
	<div class='contact-bottom'><a href='http://www.party-pooper.com'>Party Pooper Waste Management</a></div>
</div>";
